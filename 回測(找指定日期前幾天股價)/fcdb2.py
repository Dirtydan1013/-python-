...
def find_close_price(Symbol, Date,count):
    ...
    try:
        ...
        date3 = count_days(lastmonth_stockprice,Stockprice,Date, count3,month)
        date5 = count_days(lastmonth_stockprice,Stockprice,Date, count5,month)
        date7 = count_days(lastmonth_stockprice,Stockprice,Date, count7,month)
        close_price = find_price(date,Stockprice,lastmonth_stockprice,month)
        close_price3 = find_price(date3,Stockprice,lastmonth_stockprice,month)
        close_price5 = find_price(date5,Stockprice,lastmonth_stockprice,month)
        close_price7 = find_price(date7,Stockprice,lastmonth_stockprice,month)
        print(close_price,close_price3,close_price5,close_price7)
        return [close_price,close_price3,close_price5,close_price7]
    except :
        return 0
